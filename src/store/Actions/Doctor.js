...
export const addDoctor = (data, url) => {
  const options = { url: url };
  options.types = [types.ADDDOCTOR_SUCCESS, types.ADDDOCTOR_FAILURE];

  return api.postWithFormData(options, data);
};
...
export const getDoctor = (url) => {
  const options = { url: url };
  options.types = [types.GETDOCTOR_SUCCESS, types.GETDOCTOR_FAILURE];
