...
function AddEditDoctor(props) {
  ...
  const handleSubmit = (e) => {
    ...
    const data = {};
    if ((type == "hospital" || roles.includes("Super Admin")) && !id) {
    ...
    const _error = validate(data, AddEditDoctorschema);
    if (_error) return;
    ...
    if (type == "hospital" && !id) {
      formData.append("hospitalId", token.hospitalId);
      formData.append("email", value.email);
      formData.append("password", value.password);
      url = `hospital-doctors`;
    } else if (roles.includes("Super Admin") && !id) {
      // formData.append("hospitalId", token.hospitalId);
      formData.append("email", value.email);
      formData.append("password", value.password);
      url = `doctors/admin`;
    ...
    formData.append("homeVisit", "false");
    if (!id) {
      formData.append("latitude", cord.lat);
      formData.append("longitude", cord.lng);
    }
    if (value.country) {
    ...
    if (id) {
      ...
      props
        ...
        .then((response) => {
          ...
          var specialityIds = response.payload.specialityIds.split(",");
          var specialities = response.payload.speciality.split(",");

          const selectedSpeciality = specialityIds.map((item, index) => {
            return {
              label: specialities[index],
              value: item,
            };
          });

          response.payload["selectedSpeciality"] = selectedSpeciality;
  ...
  const backgroundImagecss = {
    background: ` url("https://media.istockphoto.com/id/938656872/vector/doctors.jpg?s=612x612&w=0&k=20&c=_CXmIA4SXuy_qxjYfM1vnkelwoO5M7nU0goYm0N8OwA=")`,
          ...
          <div className="main-div">
            <div className="form-container">
              <div className="row  d-flex justify-content-start ml-20">
                ...
                {(type == "hospital" || roles.includes("Super Admin")) && !id && (
                  <div className="col-md-6">
                    <label className="form-label  add-view-product-label">
                ...
                <div className="col-md-6">
                  <label className="form-label  add-view-product-label">
                    Degree <span className="Mandatory">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-controls"
                ...
                <div className="col-md-6">
                  <label className="form-label  add-view-product-label">
                    {" "}
                    Position / Occupation <span className="Mandatory">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-controls"
                    ...
                    name="position"
                    onChange={onChange}
                    placeholder="Enter  Position / Occupation"
                  />
                  {error.position && (
