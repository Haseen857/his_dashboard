...
import hrProfilePic from "../../assets/images/hrPic.jpeg";
import React, { useState, useRef, useEffect } from "react";
import { useDispatch, useSelector } from "react-redux";
import { Link, useParams } from "react-router-dom";
import Joi from "joi-browser";
import AddEditHRschema from "src/schemas/AddEditHRschema";
...
function ADDHR(props) {
  ...
  if (!value.profileUrl) value.profileUrl = hrProfilePic;
  ...
  const onChange = (e) => {
    ...
    const errorMessage = validateProperty(e.target, AddEditHRschema);
    if (errorMessage) {
  ...
  useEffect(() => {
    if (id && id != token.hrId) {
      swal({
        ...
        text: "You are Not Authorized to access this page. Contact Administrator",
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      setError({
        ...
        companyName: !value.companyName
          ...
          : error.companyName,
        sector: !value.sector ? "Sector cannot be empty" : error.sector,
        services: !value.services ? "Services cannot be empty" : error.services,
    ...
    // data["latitude "] = cord.lat ;
    // data["longitude  "] = cord.lat  ;
    // status: value.status,

    const _error = validate(data, AddEditHRschema);
    if (_error) return;
    ...
    if (
      (type == "hr" && !id) ||
      (type == roles.includes("super admin") && !id)
    ) {
      url = `hr-company`;
    }

    // formData.append("phoneNo", value.phoneNo);
    formData.append("sector", value.sector);
    ...
    formData.append(
      "profileRemove",
      value.profileRemove == undefined ? false : value.profileRemove
    );
    formData.append(
      "coverRemove",
      value.coverRemove == undefined ? false : value.coverRemove
    );
  ...
  const backgroundImagecss = {
    background: ` url("https://resources.tallysolutions.com/us/wp-content/uploads/2021/12/what-are-back-office-services-2.jpg")`,
  ...
  return (
    <>
      <form className="show12 container-fluid" onSubmit={handleSubmit}>
            ...
            <div class="row text-center">
              <div className="profile-pic-wrapper">
                <div className="pic-holder">
                  <img id="profilePic" className="pic" src={value.profileUrl} />
          ...
          <div className="form-container">
            <div className="row  d-flex justify-content-start ml-20">
              ...
              <div className="col-md-6">
                ...
                >
                  {" "}
                  Sector <span className="Mandatory">*</span>
                </label>
                <select
                  value={value.sector}
                  name="sector"
              ...
              {id && (
                <div className="col-md-6">
                  ...
                  >
                    {" "}
                    Remove Profile Picture<span className="Mandatory">*</span>
                  </label>
                  <select
                    value={value.profileRemove}
                    name="profileRemove"
                    className="form-controls"
                    onChange={onChange}
                  >
                  ...
                  {/*} <p style={{ color: "red" }}>
                    {error.profileRemove && (
                      <div class="text-danger">{error.profileRemove}</div>
                    )}
                    </p> */}
                </div>
              )}
              ...
              {id && (
                <div className="col-md-6">
                  ...
                  >
                    {" "}
                    Remove Cover Picture <span className="Mandatory">*</span>
                  </label>
                  <select
                    value={value.coverRemove}
                    name="coverRemove"
                    className="form-controls"
                    onChange={onChange}
                  >
                  ...
                  {/* <p style={{ color: "red" }}>
                    {error.coverRemove && (
                      <div class="text-danger">{error.coverRemove}</div>
                    )}
                    </p>*/}
                </div>
              )}
              ...
              <div className="col-md-6">
                <label className="form-label  add-view-product-label">
                  Services <span className="Mandatory">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="col-md-6">
                ...
                {/* {error.country && (<p class="text-danger" style={{ color: "red" }}>
                    {error.country}</p>
                )} */}
              </div>
              {/* <div className="col-md-6">
                ...
                <Select
                  options={states}
                  className="form-controls"
                  placeholder={value.state ? value.state : "Select State"}
                  // id="country"
                  data-coreui-multiple="false"
                  onChange={(valuess) => {
                    if (valuess.length > 0) {
                ...
                <p style={{ color: "red" }}>
                  {" "}
                  {error.state && <div class="text-danger">{error.state}</div>}
                </p>
              </div> */}
              <div className="col-md-6">
                <label
                ...
                ></Select>
                {/*  {error.city && (<p  class="text-danger"style={{ color: "red" }}>
                    {error.city}</p>
                  )}*/}
