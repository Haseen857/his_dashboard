...
const HRDetail = (props) => {
  ...
  const FromHRVerifyList = JSON.parse(
    localStorage.getItem(config.FromHRVerifyList)
  );
  ...
  const routeback = () => {
    if (FromHRVerifyList == true) history.push("/hrverify");
    else {
      history.push("/hrlist");
    }
  };
  ...
  const handleAcceptancetrue = (e) => {
    ...
    var url = `hr-company/admin/hr/${id}/verify`;
    props
      ...
      >
        ...
        <table id="customers">
          <tbody>
            ...
            <tr>
              <td>Sector</td>
              <td className="lightgray">{value.sector}</td>
            </tr>
            <tr>
              <td>Services</td>
              <td className="lightgray">{value.services}</td>
            </tr>
            {/* <tr>
              <td>Degree</td>
