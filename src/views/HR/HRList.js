...
const HrList = (props) => {
              ...
              if (
                ...
                (items[i].checked === true &&
                  ...
                  (items[i].companyName.toLowerCase().indexOf(searchQuery) >
                    ...
                    items[i].sector.toLowerCase().indexOf(searchQuery) > -1 ||
  ...
  useEffect(() => {
    storeObjectData(config.FromHRVerifyList, false);
    fetchAllLists();
  }, []);
  ...
  return (
    <>
      <div className="form-header">
        <h5 className="lineformtitle">HR List </h5>
      </div>
