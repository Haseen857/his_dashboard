...
//validation
import AddHospitalschema from "src/schemas/AddHospitalAdminSchema";
      ...
      if (
        ...
        setError({
          ...
          mobileNo: !value.mobileNo
            ...
            : error.mobileNo,
          email: !value.email ? "Email is required" : error.email,
          password: !value.password ? "Password is required" : error.password,
          firstName: !value.firstName
            ? "First Name is required"
            : error.firstName,
          lastName: !value.lastName ? "Last Name is required" : error.lastName,
        });
      } else {
        const data = {
          hospitalName: value.hospitalName,
        ...
        formData.append(
          "address",
          addressed.address ? addressed.address : value.address
        );
        formData.append("country", value.country);
        formData.append("latitude", lastell.lat);
        formData.append("longitude", lastell.lng);
        formData.append("email", value.email);
        formData.append("password", value.password);
        formData.append("hospitalName", value.hospitalName);

        props
          .onsubumited(formData)
          .then((response) => {
            swal({
              icon: "success",
        ...
        <div className="container-fluid">
          <div className="main-div">
            ...
            <div className="form-container">
              ...
              <div>
                ...
                <div>
                  <CModal
                    ...
                    onClose={() => (
                      setVisiblelegal(false), handleRemoveAllTagClick()
                    )}
                  >
                    <CModalHeader>
                      <CModalTitle>
              ...
              {/* <div className="row">
                        <div className="col-md-5">
                          <h6>Legal Documents From Doctor</h6>
                        </div>
                        <div className="col-md-6">
                          <div>
                            <ReactTags
